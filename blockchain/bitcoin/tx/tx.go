...
func CreateTx(privKey string, destination string, amount int64) (string, error) {
	...
	// extracting destination wallet as []byte from function argument (destination string)
	...
	// input list (contain UTXOs) and outputlist (contain destination wallet and usually our wallet)
	...
	// adding the destination wallet and the amount to
